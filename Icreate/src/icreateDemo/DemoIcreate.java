...
public class DemoIcreate {
	...
	public static void main(String args[]) throws Exception
	{
		try {
				...
				driver.get("http://jenkins.mobinius.net/login?from=%2F");
				log.log(LogStatus.PASS, "Url loaded successfully", "Url");
				Thread.sleep(5000);
				WaitForElementToDisplay(By.xpath("//input[@placeholder='Username']"), "place holder");
				driver.findElement(By.xpath("//input[@placeholder='Username']")).sendKeys("mobinius");
				Thread.sleep(1000);
